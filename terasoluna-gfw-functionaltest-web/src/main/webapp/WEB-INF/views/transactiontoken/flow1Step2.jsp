...
<form:form
	...
	<input id="btn-end" name="finalize" class="mainbtn"
		style="width: 200px;" type="submit" value="Finish" />
	<br>
	<input id="btn-in-finish" name="intermediateWithFinish" class="mainbtn"
		style="width: 200px;" type="submit" value="Next and Finish" />
	<br>
    ...
    <br>
	<input id="btn-end-error" name="finalizeError" class="mainbtn"
		style="width: 200px;" type="submit" value="Finish with Error" />
	<br>
